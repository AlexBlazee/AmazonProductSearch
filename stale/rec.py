...
class RecommendationEngine:
    ...
    def batch_search(self, query_list, top_k=15, alpha=0.5):
        df_list = []
        pretty_string_list = []
    ...
    def search(self, query, top_k=15, alpha=0.5):
        ...
        if len(sparse) > 0  and len(dense)>0 :
            ...
            print("Embedding model returned None values")
